...
CREATE TABLE `bms_collect` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='中间表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bms_collect` VALUES (1,'1741693016078385154','1741692720275095554'),(2,'1741693016078385154','1741690748339847170');
...
INSERT INTO `bms_comment` VALUES ('1741696035884990466','讲得好','1741693016078385154','1741692720275095554','2024-01-01 13:41:09',NULL),('1741696091988000769','不错不错','1741693016078385154','1741690748339847170','2024-01-01 13:41:22',NULL),('1741701858631647233','不错不错','1741693016078385154','1741695911695843329','2024-01-01 14:04:17',NULL);
...
CREATE TABLE `bms_follow` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='用户关注';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bms_follow` VALUES (1,'1741690336719241218','1741693016078385154');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='话题-标签 中间表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-01-01 14:05:52
